import pygame
import random #Will be used for random moves computer does
from abc import ABC
...
class Display:
    ...
    #All of the colour settings for the display of the game can be modified to any colour
    colours = {
        "water": pygame.color.Color("blue"),
        "ship": pygame.color.Color("green"),
